...
if program_not_installed "FoxitReader"; then
	...
	runcmd "wget http://cdn01.foxitsoftware.com/pub/foxit/reader/desktop/linux/2.x/2.2/en_us/FoxitReader2.2.1025_Server_x64_enu_Setup.run.tar.gz -P ${home}/Downloads/"
    else
	# 32-bit
	echo "Detected that you're running a 32-bit OS, will install 32-bit version of Foxit PDF Reader"
	runcmd "wget http://cdn01.foxitsoftware.com/pub/foxit/reader/desktop/linux/2.x/2.2/en_us/FoxitReader2.2.1025_Server_x86_enu_Setup.run.tar.gz -P ${home}/Downloads/"
    fi
